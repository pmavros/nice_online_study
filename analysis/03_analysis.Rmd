...
p_crowd <- preds |> 
  ...
  scale_color_manual(values = c("urban" = "brown", "green" = "#4CAF50")) +
  ...
  labs(x  = "Pedestrian counts", y = "Perceived Crowdedness (1-7)") +
  # coord_cartesian(ylim = c(1, 7)) +
  theme_modern() +
  theme(strip.placement = "outside", 
        strip.text.x = element_text(hjust = 0, size = 12)) +
  ggnewscale::new_scale_fill() +
  scale_fill_manual(values = c("urban" = "brown", "green" = "#4CAF50")) +
...
ggsave(p_crowd, filename = "output/plots_perc_crowd.jpg", width = 10, height = 7, dpi = 300)
```
