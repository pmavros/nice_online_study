...
t2 <- BayesFactor::ttestBF(formula = Crowd_Preference_Mean ~ Upbringing_Environment, data = df_participants |> filter(!is.na(Crowd_Preference_Mean)))
t3 <- BayesFactor::ttestBF(formula = Crowd_Preference_Mean ~ Current_Environment, data = df_participants |> filter(!is.na(Crowd_Preference_Mean)))
